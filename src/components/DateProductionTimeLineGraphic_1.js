...
const DateProductionTimeLineGraphic_1 =({temporada})=>{
    const [dateList, setDateList] = useState(temporada.productionDates);
    const [priceList, setPriceList] = useState(temporada.temporadaProduccionBruta);
    ...
    const CustomLine = ({ line }) => (
        <Path key="line" d={line} stroke="#49FF05" strokeWidth={apx(6)} fill="none" />
    );
    ...
    const CustomGradient = () => (
        <Defs key="gradient">
            <LinearGradient id="gradient" x1="0" y="0%" x2="0%" y2="100%">
                ...
                <Stop offset="0%" stopColor="#A9FF89" stopOpacity={0.9} />
                <Stop offset="100%" stopColor="#A9FF89" stopOpacity={0} />
            </LinearGradient>
        </Defs>
    );
            ...
            <G x={x(positionX)} key="tooltip">
                <G
                    ...
                    <Rect
                        ...
                        fill="#D0FFC2"
                    />
                    <SvgText x={apx(20)} fill="gray" opacity={0.65} fontSize={apx(24)}>
                        {date}
                    </SvgText>
                    <SvgText
                        x={apx(20)}
...
export default DateProductionTimeLineGraphic_1